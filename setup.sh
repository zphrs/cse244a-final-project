# make sure you have cuda, python, and miniconda
...
conda install -c rapidsai -c conda-forge -y cuvs cuda-version=12.8 # install cuvs based on your cuda version
conda install -c conda-forge -y cupy
